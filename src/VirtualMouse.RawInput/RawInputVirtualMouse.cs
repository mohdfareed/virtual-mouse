...
public sealed partial class RawInputVirtualMouse : IVirtualMouse, IDisposable
{
    ...
    public static Task<RawInputVirtualMouse> ConnectAsync(CancellationToken cancellationToken = default)
    {
        cancellationToken.ThrowIfCancellationRequested();
#pragma warning disable CA2000 // Ownership transfers to the caller.
        return Task.FromResult(new RawInputVirtualMouse());
